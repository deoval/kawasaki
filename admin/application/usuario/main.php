    ...
    <body class="main">
                            ...
                            <div class="widget-content">
                                ...
                                <section>
                                    ...
                                    <div class="pull-right col-md-2">
                                        <a href="../usuario/form.php" class="btn btn-default">
                                            <i class="icon-plus"></i>
                                            Novo cadastro
                                        </a>
                                    </div>
        ...
        <div class="content">
            ...
            <div id="pad-wrapper" class="users-list">
                ...
                <div class="row header">
                    <div class="box-add">
                        ...
                        <div class="pull-right">
                            <form class="form-search" id="filtroUsuario" name="filtroUsuario" onsubmit="Usuario.lista(0);
                  return false">
                ...
                <div class="row">
                    <table class="table table-hover" id="grid-usuario">
                        <thead>
                            <tr>
                ...
                <div class="col-md-12">
                    ...
                    <ul class="pagination pull-right" id="pagination-usuario">
                    </ul>
                </div>
                <!-- end users table -->
            </div>
        ...
        */
        ...
        <script type="text/javascript">Usuario.lista();</script>
    </body>
</html>