                    ...
                    <div class="col-md-12">      		
                        ...
                        <div class="widget stacked ">
                            ...
                            <div class="widget-content">
                                <br />
                                <section>
                                    <form class="form-horizontal col-md-4" id="filtroSolicitacao" name="filtroSolicitacao" onsubmit="Solicitacao.lista(0);return false">
                                    ...
                                    <div class="pull-right col-md-2">
                                        <a href="../solicitacao/form.php" class="btn btn-default">
                                            <i class="icon-plus"></i>
                                            Novo cadastro
                                        </a>
                                    </div>
