...
//  var $cache = 'cache/'; // Cache folder
    ...
    /**
     * function encode(string $image)
     *
     * This function embeds the image into HTML by enconding it to base 64
     *
     * return string
     */
    function encode($image) {
        ...
        $fd = fopen ($image, 'rb');
        $cont = fread ($fd, filesize ($image));
        fclose ($fd);

        return "data:image/".$this->allowed[$this->data[2]].";base64,".base64_encode($cont);
    }
